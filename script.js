...
const products = [
  ...
  {id:8, name: "Silk Midi Dress", category: "Clothing-Women", price: 3400, imageUrl: "image/silk-dress.jpg", summary: "Minimal cut · Fluid drape", description: "A silk midi dress with a graceful drape and refined movement. Designed for understated glamour — minimal lines, maximum impact, and a luxurious feel against the skin."},
  {id:9, name: "Cashmere Knit Top", category: "Clothing-Women", price: 1800, imageUrl: "image/cashmere-top.jpg", summary: "Soft handle · Relaxed fit", description: "A cashmere knit top with a smooth finish and flattering fit. Quiet luxury at its best — a refined essential designed to pair effortlessly with tailored pieces."},
  ...
  {id:22, name: "Leather Low-Top Sneaker", category: "Shoes-Men", price: 1700, imageUrl: "images/leather-low-top-sneakers", summary: "Hand-finished · Vintage-inspired", description: "A leather low-top sneaker with a clean silhouette and luxury finish. Designed for understated everyday wear — comfort, simplicity, and polish in one."},
  {id:23, name: "Leather Lace-Up Boots", category: "Shoes-Men", price: 2400, imageUrl: "images/leather-lace-up-boots", summary: "Structured sole · Refined profile", description: "Leather lace-up boots crafted for structure and durability. A bold, timeless staple — designed to carry you through winter with confidence and style."},
]
